	...
	<div class="span12">
		...
		<fieldset>
			...
			echo $this->Form->input('Product.title', array(
					'label' => array('text' => 'Titulo do Produto: '),
					'class' => 'span12',
					'readonly' => 'readonly'
				) 
			);
			echo $this->Form->hidden('Media.0.model', array('value'=>'Product'));
...
<div class="row-fluid">
	<div class="span12">
		...
		foreach ($medias as $key => $media) {
			echo $this->Html->image('/files/media/'.$media['Media']['dir'].'/small_'.$media['Media']['media'], array('alt'=>$media['Product']['title'], 'class'=>'img-polaroid'));
